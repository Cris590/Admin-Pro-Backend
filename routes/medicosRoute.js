...
const { getMedicos, crearMedico, actualizarMedico, borrarMedico, getMedicoById } = require('../controlers/medicoControler')
const router = Router();

//CRUD
// Se pone router en vez de app pra Medico llamado a la accion 
router.get('/', validarJWT, getMedicos); // La funcion getUsuarios no se ejecuta, solo se llama ... la ejecucion se realiza como tal en el controlador 
